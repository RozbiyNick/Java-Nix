				...
				<div class="col-3">
					<form:form modelAttribute="loginForm" method="post">
					  <div class="form-group">
					    ...
					    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter login" name="username" value="${requestScope.loginForm.getUsername()}">
					  </div>
					  <div class="form-group">
					...
					<c:if test="${requestScope.formWrong}">
						<ul class="error">
